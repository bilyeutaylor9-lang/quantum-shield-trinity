...
import "../examples/vulnerable-contract.sol";
import "../examples/reentrancy-attacker.sol";
import "../examples/tx-origin-phishing.sol";
import "../examples/delegatecall-victim.sol";
import "../examples/delegatecall-takeover.sol";
...
contract VulnerableExamplesTest is Test {
    ...
    function testTxOriginPhishingDrain() public {
        TxOriginPhishingAttack phishing = new TxOriginPhishingAttack(address(vault));
